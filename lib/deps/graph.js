 ...
 * @param {String} value The rank values 
 * @return {Rank}
 * @api public
 */
Graph.prototype.addRank = function (type, value) {
  var _type = type;
  var _value = value;

  var rank = new Rank(this, _type, _value);
...
Graph.prototype.to_dot = function () {
  ...
  for (var i in this.ranks) {
    if (this.ranks.hasOwnProperty(i)) {
      dotScript = dotScript + '  ' + this.ranks[i].to_dot() + '\n';
    }
  }
